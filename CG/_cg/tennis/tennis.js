...
console.log(computeGameState("P1", "P2", ["P1"])); // 15 - 0
console.log(computeGameState("P1", "P2", ["P2", "P2"])); // 0 - 30
console.log(computeGameState("P1", "P2", ["P1", "P1", "P1"])); // 40 - 0
console.log(computeGameState("P1", "P2", ["P1", "P1", "P1", "P1"])); // Simple victory
console.log(computeGameState("P1", "P2", ["P1", "P2"])); // 15a
console.log(computeGameState("P1", "P2", ["P1", "P2", "P1", "P1"])); // 40 - 15
console.log(computeGameState("P1", "P2", ["P1", "P2", "P1", "P2"])); // 30a
console.log(
  computeGameState("P1", "P2", ["P1", "P2", "P1", "P1", "P2", "P2", "P1", "P2"])
); // DEUCE
console.log(
  computeGameState("P1", "P2", [
    "P1",
    "P2",
    "P1",
    "P1",
